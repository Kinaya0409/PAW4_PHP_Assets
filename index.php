...
<body>
    <header class="fixed-top" id="navbar">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
            <a href="./login.php" class="nav-link text-bg-success">Admin Login</a>
            </li>
        </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="row featurette">
                ...
                <p class="lead">
                    Nomor Pokok Mahasiswa: <strong>[NPM LENGKAP]</strong>.
                </p>
                </div>

                <div class="col-md-5">
                <img src="./assets/images/featurette-padel1.webp"
            ...
            <div class="row featurette">
                ...
                <p class="lead">
                    Our padel courts are designed to blend seamlessly with nature,
                    offering a refreshing, aesthetic, and tranquil playing experience
                    with breathtaking greenery views.
                </p>
                </div>

                <div class="col-md-5 order-md-1">
                <img src="./assets/images/featurette-padel2.jpeg"
                    class="featurette-image img-fluid mx-auto rounded shadow"
